...
struct RequestWeatherUseCase: RequestWeatherUseCaseProtocol {
    
    private let logger = Logger(subsystem: "io.doyoung.Lookbook.RequestWeatherUseCase", category: "Use Case")
